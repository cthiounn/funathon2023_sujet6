...
RUN curl -SL https://minio.lab.sspcloud.fr/cthiounn2/model_yannis_v1.tar.gz -o model_yannis.tar.gz && tar -xzvf model_yannis.tar.gz && rm -rf model_yannis.tar.gz && mv model_vector .
